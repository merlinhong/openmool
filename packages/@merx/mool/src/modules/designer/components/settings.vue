          ...
          return (
            <ul style="overflow: auto; height: 200px;width: 100%;display: flex;flex-wrap: wrap;">
              {Object.keys(ElementPlusIconsVue).map((icon) => {
                ...
                }} style="padding: 10px; cursor: pointer; display: flex;align-items: center;justify-content: center;"><el-icon size="25"><IconComponent /></el-icon></li>;
              })}
            </ul>
          )
        },
          ...
          return (
            <ul v-infinite-scroll={load}
              ...
              {items.value.map((item) => {
                return <el-image key={item} style="width: 100px; height: 100px" fit="fill" onClick={()=>{
      ...
      },
      {
        ...
        render(data, col) {
          return (
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="#000000" d="M4 4V3H3v1zm7.293 8.707a1 1 0 0 0 1.414-1.414zM5 10V4H3v6zM4 5h6V3H4zm-.707-.293l8 8l1.414-1.414l-8-8z" /><path fill="#000000" d="M4 20v1H3v-1zm7.293-8.707a1 1 0 0 1 1.414 1.414zM5 14v6H3v-6zm-1 5h6v2H4zm-.707.293l8-8l1.414 1.414l-8 8z" /><path fill="#000000" d="M20 4V3h1v1zm-7.293 8.707a1 1 0 0 1-1.414-1.414zM19 10V4h2v6zm1-5h-6V3h6zm.707-.293l-8 8l-1.414-1.414l8-8z" /><path fill="#000000" d="M20 20v1h1v-1zm-7.293-8.707a1 1 0 0 0-1.414 1.414zM19 14v6h2v-6zm1 5h-6v2h6zm.707.293l-8-8l-1.414 1.414l8 8z" /></svg>
            </div>
          );
        },
      },
