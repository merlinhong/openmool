      ...
      if (indicatorWrap) {
        ...
        if (indicators.length > 0) {
          ...
          if (number) {
            ...
            //segmented controls
            var controlItems =
              indicatorWrap.querySelectorAll('.mui-control-item');
...
(function ($, window, name) {
  ...
  Toggle.prototype.start = function (e) {
    this.handle.style.webkitTransitionDuration =
      this.element.style.webkitTransitionDuration = '.2s';
...
(function ($, window, document) {
  ...
  window.addEventListener($.EVENT_START, function (event) {
    ...
    (cell = false), (a = false);
    (isMoved = false), (isOpened = false), (openedActions = false);
    var target = event.target;
...
(function ($, window, document) {
  ...
  Input.prototype.setPlaceholder = function (text) {
    if (this.searchActionClass) {
      var placeholder =
        this.element.parentNode.querySelector(SELECTOR_PLACEHOLDER);
      placeholder &&
