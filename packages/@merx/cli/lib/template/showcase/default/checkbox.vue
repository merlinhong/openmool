<template>
    <div class="container">
        <van-header title="Checkbox 复选框"></van-header>
        <div class="van-content">
            ...
            <van-checkbox disabled>复选框</van-checkbox>

            <h4 class="cell-title">自定义颜色</h4>
            <van-checkbox v-model="checked" checked-color="#07c160">自定义颜色</van-checkbox>
            ...
            <van-checkbox-group v-model="result1" @change="onChangeValue">
                <van-checkbox v-for="(item, index) in list" :key="index" :name="item">复选框 {{ item }}</van-checkbox>
            </van-checkbox-group>

            <h4 class="cell-title">设置最大可选数</h4>
            ...
            <van-checkbox-group v-model="result">
                <van-cell-group>
                    ...
                    >
                        <template #right-icon>
                            <van-checkbox :name="item" ref="checkboxes" style="padding: 0" />
                        </template>
                    </van-cell>
                </van-cell-group>
            </van-checkbox-group>
