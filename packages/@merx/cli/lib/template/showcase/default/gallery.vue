<template>
    <div class="container">
        <van-header title="Gallery 轮播"></van-header>
        <div class="van-content">
            ...
            <van-gallery :data="images" :autoplay="3000" indicator-color="white" @click="onClick"></van-gallery>
            ...
            <van-gallery :data="[1, 2, 3, 4]" :width="300" class="demo-gallery--base"></van-gallery>

            <h4 class="cell-title">自定义指示器</h4>
            <van-gallery :data="[1, 2, 3, 4]" :autoplay="3000" class="demo-gallery--base" @change="onChange">
